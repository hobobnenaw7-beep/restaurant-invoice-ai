          ...
          <div className="rounded-xl border border-dashed border-slate-300 bg-slate-50/50 p-4" data-testid="purchase-upload-zone">
            {uploadFile ? (
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-4 gap-2" data-testid="purchase-upload-options">
                  <button
                  ...
                  <button
                    ...
                    className="flex flex-col items-center gap-1.5 p-3 rounded-lg border border-slate-200 bg-white hover:border-teal-300 hover:bg-teal-50/50 transition-all group"
                    data-testid="purchase-upload-excel-btn"
                  >
            ...
            <input ref={fileExcelRef} type="file" className="hidden" accept=".xlsx,.xls,.csv,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel,text/csv" onChange={(e) => handleFileSelect(e.target.files?.[0])} data-testid="purchase-excel-input" />
          </div>
